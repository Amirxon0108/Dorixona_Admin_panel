...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   User Grid | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
         <div>
          <ul class="nav nav-pills">
           <li class="nav-item">
            <a class="nav-link" data-bs-placement="top" data-bs-toggle="tooltip" href="apps-contacts-list.html" title="List">
             <i class="bx bx-list-ul">
             </i>
            </a>
           </li>
           <li class="nav-item">
            <a class="nav-link active" data-bs-placement="top" data-bs-toggle="tooltip" href="apps-contacts-grid.html" title="Grid">
        ...
        <div class="card text-center">
         <div class="card-body">
          <div class="dropdown text-end">
           <a aria-haspopup="true" class="text-muted dropdown-toggle font-size-16" data-bs-toggle="dropdown" href="#" role="button">
            <i class="bx bx-dots-horizontal-rounded">
            </i>
           </a>
           <div class="dropdown-menu dropdown-menu-end">
       ...
       <div class="col-xl-3 col-sm-6">
        <div class="card text-center">
         <div class="card-body">
          ...
          <div class="mx-auto mb-4">
           <img alt="" class="avatar-xl rounded-circle img-thumbnail" src="assets/images/users/avatar-6.jpg"/>
          </div>
          <h5 class="font-size-16 mb-1">
           <a class="text-body" href="#">
            Tommy Hayes
       ...
       <div class="col-xl-3 col-sm-6">
        <div class="card text-center">
         <div class="card-body">
          ...
          <div class="mx-auto mb-4">
           <img alt="" class="avatar-xl rounded-circle img-thumbnail" src="assets/images/users/avatar-8.jpg"/>
          </div>
          <h5 class="font-size-16 mb-1">
           <a class="text-body" href="#">
            Diana Owens
       ...
       <div class="col-xl-3 col-sm-6">
        <div class="card text-center">
         <div class="card-body">
          ...
          <div class="mx-auto mb-4">
           <img alt="" class="avatar-xl rounded-circle img-thumbnail" src="assets/images/users/avatar-9.jpg"/>
          </div>
          <h5 class="font-size-16 mb-1">
           <a class="text-body" href="#">
            Paul Sanchez
