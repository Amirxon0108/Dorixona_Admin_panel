...
@endif
          ...
          <form action="{{route('register')}}" method="POST" class="needs-validation mt-4 pt-2" novalidate="">
          @csrf 
          <div class="mb-3">
            <label class="form-label" for="useremail">
             Email
            </label>
            <input class="form-control" name="email" id="useremail" placeholder="Enter email" required="" type="email"/>
           ...
           <div class="mb-3">
            ...
            <input class="form-control" name="name"  id="username" placeholder="Enter username" required="" type="text"/>
            <div class="invalid-feedback">
